...
/*
Cột type
Hệ thống đã thoát khỏi cảnh quét toàn bảng (Full Table Scan) nghĩa là nó dùng Index để nhảy thẳng tới dòng chứa tên cần tìm

Cột rows
Thay vì phải duyệt qua hàng trăm nghìn bệnh nhân để tìm kiếm, chỉ cần đọc đúng 1 dòng duy nhất
*/
...
Phần A
Phân tích lỗi:
- Làm lộ bảo mật thông tin có thể gây kì thị người đọc và quyền riêng tư của bệnh nhân qua 2 cột:
hiv_status, mental_health_history
*/
CREATE VIEW reception_patient_view AS
SELECT patient_id, full_name, age, room_number, hiv_status, mental_health_history FROM patients;
